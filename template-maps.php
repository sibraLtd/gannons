...
<div class="row"> 
    ...
    <a href="http://www.gannons.co.uk/contact/holborn/" title="20-21 Jockey's Fields, Holborn, London WC1R 4BW UK map" target="_blank">
       <div class="col-xs-4 col-sm-3   col-md-2 col-lg-2  text-center">
        <div class="locations"><p>Holborn</p></div>
    </div></a> 
    
   
    <a href="http://www.gannons.co.uk/contact/the-city/" title="68, Lombard Street, London. EC3V 9LJ map" target="_blank">
    <div class="col-xs-4  col-sm-3 col-md-2  col-lg-2 text-center locationBox">

    ...
    <div class="container">
        ...
        <div class="row"> 
            ...
            <?php include( locate_template( 'content_header.php', false, false ) ); ?>
                ...
                <ul class="blog-date">
                    <li><i class="fa fa-user byline"></i><span itemprop="author" content="<?php the_author(); ?>" /> <?php the_author_posts_link();//the_author(); ?> <?php // the_author(); ?></span></li>
                 <li><i class="fa fa-calendar"></i><span itemprop="datePublished" content="<?php echo get_the_date('c'); ?>" /><?php echo get_the_date(get_option('date_format')); ?></span></li>
                       
                 <li><meta itemprop="copyrightHolder" content="Gannons solicitors"/></li>
                 <li><meta itemprop="dateModified" content="<?php the_modified_date('c'); ?>"/></li>
                 <li><meta itemprop="wordCount" content="<?php echo word_count( get_the_ID() ); ?>"/></li>
                 <li><meta itemprop="image" content="<?php echo sibra_author_link( get_the_author_meta( 'display_name' ) ); ?>" alt="<?php echo get_the_author_meta( 'display_name' ); ?>: Picture of the author " /></li>

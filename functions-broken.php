...
function sibra_author_image( $author) {    
    switch ($author) {
             case 'Alex Kleanthous': return '<img src="' .  get_site_url() . '/wp-content/uploads/2016/08/alex-kleanthous-formal-330.jpg" alt="Alex Kleanthous works across a range of sectors for companies and individuals. The main focus is on resolving shareholder disputes, partnership disputes, commercial disputes, employment disputes – in fact disputes of most kinds." />';
                  break;
             case 'Catherine Gannon': return '<img src="' .  get_site_url() . '/wp-content/uploads/2016/08/catherine-gannon-navy-330.jpg" alt="Catherine Gannon, managing partner Gannons solicitors, who has a tax, accountancy and a legal background."/>';
                 break; 
             case 'Helen Curtis': return '<img src="' .  get_site_url() . '/wp-content/uploads/2016/08/helen-curtis-330.jpg" alt="Helen Curtis focuses on business law, employee incentives, private equity related transactions and mergers & acquisitions."/>';
                 break; 
              case 'George Stead': return '<img src="' .  get_site_url() . '/wp-content/uploads/2016/08/george-stead-formal-330.jpg" alt="George advises on intellectual property registration and litigation. George also advises shareholders on initial agreements and remedies on breakdown and supports both the corporate and dispute resolution teams." />';
                 break;
             case 'Himanshu Dasare': return '<img src="' .  get_site_url() . '/wp-content/uploads/2016/08/himanshu-dasare-formal-330.jpg" alt="Himanshu Dasare advises across the full spectrum of intellectual property issues, including registration and defence of trademark, design, copyright and patents." />';
                 break;
             case 'Jeremy Scholl': return '<img src="' .  get_site_url() . '/wp-content/uploads/2016/09/jeremy-scholl-330.jpg" alt="Jeremy Scholl has expertise across share valuations, international tax planning, corporate tax, capital gains tax, VAT, tax planning for group companies and personal tax planning."/>';
                 break; 
             case 'John Deane': return '<img src="' .  get_site_url() . '/wp-content/uploads/2016/08/john-deane-formal-330.jpg" alt="John Deane has have over 25 years experience providing corporate and commercial legal services to SMEs and their investors. He has many years experience in partnership law and as a qualified mediator  "/>';
                 break;    
              case 'Desiree De Lima': return '<img src="' .  get_site_url() . '/wp-content/uploads/2016/08/lisa-faragher-330.jpg" alt="Desiree De Lima: intellectual property solictor. Expertise: Software & mobile applications, Branding & design, Managing IP portfolios, IP enforcement & defence" />';
                 break; 
             case 'Mala Patel': return '<img src="' .  get_site_url() . '/wp-content/uploads/2016/08/mala-patel-330.jpg" alt=" advises on intellectual property protection and exploitation, business transactions and shareholder agreements " />';
                break;
             ...
             break;
             case 'Veronika Lipinska': return '<img src="' .  get_site_url() . '/wp-content/uploads/2016/08/veronika-lipinska-330.jpg" alt="Veronika Lipinska: Commercial tax & corporate solicitor: advises on employee share ownership, taxation of corporate transactions, negotiations with HMRC" />';
                 break; 
            
             case 'Julie Greenwood': return '<img src="' .  get_site_url() . '/wp-content/uploads/2016/09/julie-greenwood.jpg" alt="Julie Greenwood: Client services and HR manager at Gannons Solicitors Londontes." />';
                  break;
         }
}
...
function contactInfo($pageAuthor, $askPageID, $page_link ) {
                ...
                $team = '<div class="contactPerson"><div class="contactDetails">';
                     ...
                     if (substr_count($page_link, 'company') > 0 ) {
                             ...
                             . '<a class="teamAuthor" href="http://www.gannons.co.uk/solicitor/george-stead/" target="_blank">George&nbsp;Stead, </a>'                             
                             . '<a class="teamAuthor" href="http://www.gannons.co.uk/solicitor/mala-patel/" target="_blank">Mala&nbsp;Patel.</a>'
                             ;
                                              
                    if (substr_count($page_link, 'contract') > 0 ) {
                                              $team .= '<h2>Corporate team</h2>' 
                             .  '<a class="teamAuthor" href="http://www.gannons.co.uk/solicitor/catherine-gannon/" target="_blank">Catherine&nbsp;Gannon, </a>'
                             . '<a class="teamAuthor" href="http://www.gannons.co.uk/solicitor/john-deane/" target="_blank">John&nbsp;Deane, </a>' 
                             . '<a class="teamAuthor" href="http://www.gannons.co.uk/solicitor/helen-curtis/" target="_blank">Helen&nbsp;Curtis, </a>'                             
                             ...
                             . '<a class="teamAuthor" href="http://www.gannons.co.uk/solicitor/john-deane/" target="_blank">John&nbsp;Deane, </a>'                          
                             . '<a class="teamAuthor" href="http://www.gannons.co.uk/solicitor/team/matt-gingell/" target="_blank">Matt Gingell,&nbsp;</a>'
                             . '<a class="teamAuthor" href="http://www.gannons.co.uk/solicitor/george-stead/" target="_blank">George Stead,&nbsp;</a>'
                             ...
                             . '<a class="teamAuthor" href="http://www.gannons.co.uk/solicitor/catherine-gannon/" target="_blank">Catherine Gannon,&nbsp;</a>'
                             . '<a class="teamAuthor" href="http://www.gannons.co.uk/solicitor/helen-curtis/" target="_blank">Helen Curtis,&nbsp;</a>'
                             . '<a class="teamAuthor" href="http://www.gannons.co.uk/solicitor/veronika-lipinska/" target="_blank">Veronika Lipinska.</a>'
                             ;
...
function sibra_author_link( $page_author) {
    switch ($page_author) {
             ...
             case 'Lisa Faragher': return get_site_url() . '/wp-content/uploads/2016/08/lisa-faragher-800.jpg'; break;  
